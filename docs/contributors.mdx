...
export const Contrib = ({children, name, pic, page_id, socials}) => (
  <tr id={page_id}>
    <td>
      <img src={pic} alt={ name + " Profile Picture"}/>
...
<table>
  <tbody>
    ...
    <Contrib name="Kate Barry, The Assembly Line 209A Czar" pic="/img/contributors/robby.jpg" page_id="kate_barry">
    ...
    <Contrib name="Esme Caramello" pic="/img/contributors/robby.jpg" page_id="caramello"
